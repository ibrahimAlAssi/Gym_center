...
#[AsCommand(name: 'make-app:middleware')]
class MiddlewareMakeCommand extends ConsoleMiddlewareMakeCommand
{
     ...
     * @var string
     */
    protected $name = 'make-app:middleware';
     ...
     * @deprecated
     */
    protected static $defaultName = 'make-app:middleware';
    ...
    {
        return [
            ['name', InputArgument::REQUIRED, 'The name of the middleware class.'],
    ...
    protected function getDefaultNamespace($rootNamespace)
    {
        ...
        return $rootNamespace.'\Src\\'.(Str::title($app)).'\\'.(Str::title($group)).'\\Middlewares';
    }
}
